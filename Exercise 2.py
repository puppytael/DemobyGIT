...
station = ["lighthouse"": ""2003","Harmaja"":" "1989" ,"suomenlinna aaltopoiju" ":""2016" ,"kumpula"":""2005", "Kaisaniemi" ":""1844"]
print(station)
# listing stations
...
print_statement = "The average temperature in Helsinki in " + str(months[selected_month_index]) + " is " + str(average_temp[selected_temp_index])
